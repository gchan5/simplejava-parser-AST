...
public class simplejava implements simplejavaConstants {
 ...
 ASTFunction main; ASTFunctionDefinitions f = new ASTFunctionDefinitions();
    main = main_func();
                        f.addElement(main);
     {if (true) return new ASTProgram(new ASTClasses(), f, 0);}
    jj_consume_token(0);
    throw new Error("Missing return statement in function");
  }

  static final public ASTFunction main_func() throws ParseException {
 ASTFunction result; ASTStatement s;
    ...
    jj_consume_token(RIGHT_BRACE);
         {if (true) return new ASTFunction("void", "main", new ASTFormals(), s, 0);}
    throw new Error("Missing return statement in function");
  }

  static final public ASTStatements statements() throws ParseException {
 ASTStatements s = new ASTStatements(); ASTStatement statement;
  ...
  static final public ASTVariableDefStatement variable_def() throws ParseException {
 Token type; Token name;
    type = jj_consume_token(IDENTIFIER);
    name = jj_consume_token(IDENTIFIER);
    jj_consume_token(SEMICOLON);
         {if (true) return new ASTVariableDefStatement(type.image, name.image, 0);}
    throw new Error("Missing return statement in function");
  }
